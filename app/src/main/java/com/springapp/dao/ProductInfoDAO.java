...
public interface ProductInfoDAO {
    @Insert("insert into product_info(id,batch,color,sequence,season,order_num,price,category,gmt_create) "
            + "values(#{id},#{batch},#{color},#{sequence},#{season},#{orderNum},#{price},#{category},#{gmtCreate})")
